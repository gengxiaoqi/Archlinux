...
complete -c mpg123 -l no-seekbuffer --description 'Disable the default micro-buffering of non-seek… [See Man Page]'
...
complete -c mpg123 -l no-infoframe --description 'Do not parse the Xing/Lame/VBR/Info frame, deco… [See Man Page]'
...
complete -c mpg123 -l title --description 'In an xterm, rxvt, screen, iris-ansi (compatibl… [See Man Page]'
