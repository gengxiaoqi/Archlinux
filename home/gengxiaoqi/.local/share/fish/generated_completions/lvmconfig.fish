...
complete -c lvmconfig -l profile --description 'The same as using --commandprofile but the conf… [See Man Page]'
complete -c lvmconfig -l metadataprofile --description 'Use ProfileName to override existing configuration.'
complete -c lvmconfig -l mergedconfig --description 'When the lvmconfig command is run with the --co… [See Man Page]'
...
complete -c lvmconfig -l validate --description 'Validate current configuration used and exit wi… [See Man Page]'
...
complete -c lvmconfig -l withspaces --description 'Where appropriate, add more spaces in output fo… [See Man Page]'
complete -c lvmconfig -l withversions --description 'Also display a comment containing the version o… [See Man Page]'
