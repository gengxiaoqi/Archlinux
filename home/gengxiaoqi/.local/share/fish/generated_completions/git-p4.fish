...
complete -c git-p4 -l max-changes --description 'Import at most n changes, rather than the entir… [See Man Page]'
complete -c git-p4 -l changes-block-size --description 'The internal block size to use when converting … [See Man Page]'
...
complete -c git-p4 -l 'use-client-spec.' --description 'git-p4. pathEncoding.'
