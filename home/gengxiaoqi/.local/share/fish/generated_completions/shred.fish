...
complete -c shred -s u --description 'truncate and remove file after overwriting.'
...
complete -c shred -s x -l exact --description 'do not round file sizes up to the next full blo… [See Man Page]'
