...
complete -c git-branch -s u -l set-upstream-to --description 'Set up <branchname>\\*(Aqs tracking information … [See Man Page]'
...
complete -c git-branch -l 'delete)' --description '.'
complete -c git-branch -l 'move)' --description '.'
