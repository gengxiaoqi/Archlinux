...
complete -c cryptsetup-reencrypt -l decrypt --description 'Remove encryption (decrypt already encrypted de… [See Man Page]'
complete -c cryptsetup-reencrypt -l use-directio --description 'Use direct-io (O_DIRECT) for all read/write dat… [See Man Page]'
...
complete -c cryptsetup-reencrypt -l uuid --description 'Use only while resuming an interrupted decrypti… [See Man Page]'
...
complete -c cryptsetup-reencrypt -l 'uuid]' --description '.'
