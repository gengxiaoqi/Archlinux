...
complete -c fdisk -s B -l protect-boot --description 'Don\'t erase the begin of the first disk sector … [See Man Page]'
...
complete -c fdisk -s w -l wipe --description 'Wipe filesystem, RAID and partition-table signa… [See Man Page]'
