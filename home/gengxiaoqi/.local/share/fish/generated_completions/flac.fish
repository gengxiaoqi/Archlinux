...
complete -c flac -l preserve-modtime --description 'Output files have their timestamps/permissions … [See Man Page]'
complete -c flac -l keep-foreign-metadata --description 'If encoding, save WAVE, RF64, or AIFF non-audio… [See Man Page]'
...
complete -c flac -l apply-replaygain-which-is-not-lossless --description '.'
...
complete -c flac -l ignore-chunk-sizes --description 'When encoding to flac, ignore the file size hea… [See Man Page]'
...
complete -c flac -s 6 -l compression-level-6 --description 'Synonymous with -l 8 -b 4096 -m -r 6 -A tukey(0.'
complete -c flac -s 7 -l compression-level-7 --description 'Synonymous with -l 8 -b 4096 -m -e -r 6 -A tukey(0.'
