...
complete -c unxz -l ignore-check --description 'Don\'t verify the integrity check of the compres… [See Man Page]'
...
complete -c unxz -l flush-timeout --description 'When compressing, if more than  timeout millise… [See Man Page]'
...
complete -c unxz -l rsyncable --description 'has been implemented, the resulting files won\'t… [See Man Page]'
