...
complete -c efibootmgr -s B -l delete-bootnum --description 'Delete bootnum (hex).'
...
complete -c efibootmgr -s u -l unicode -l UCS-2 --description 'pass extra command line arguments as UCS-2 (default is ASCII).'
