...
complete -c logger -l no-act --description 'Causes everything to be done except for writing… [See Man Page]'
...
complete -c logger -l sd-id --description 'Specifies a structured data element ID for an R… [See Man Page]'
complete -c logger -l sd-param --description 'Specifies a structured data element paramameter… [See Man Page]'
