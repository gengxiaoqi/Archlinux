...
complete -c findmnt -s b -l bytes --description 'Print the SIZE, USED and AVAIL columns in bytes… [See Man Page]'
...
complete -c findmnt -s e -l evaluate --description 'Convert all tags (LABEL, UUID, PARTUUID or PART… [See Man Page]'
...
complete -c findmnt -s M -l mountpoint --description 'Explicitly define the mountpoint file or directory.'
complete -c findmnt -s m -l mtab --description 'Search in R /etc/mtab .'
complete -c findmnt -s N -l task --description 'Use alternative namespace /proc/<tid>/mountinfo… [See Man Page]'
...
complete -c findmnt -s s -l fstab --description 'Search in R /etc/fstab .'
...
complete -c findmnt -s U -l uniq --description 'Ignore filesystems with duplicate mount targets… [See Man Page]'
