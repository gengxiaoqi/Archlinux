...
complete -c last -s d -l dns --description 'For non-local logins, Linux stores not only the… [See Man Page]'
complete -c last -s f -l file --description 'Tell  last to use a specific file instead of  /var/log/wtmp .'
complete -c last -s F -l fulltimes --description 'Print full login and logout times and dates.'
complete -c last -s i -l ip --description 'Like  --dns , but displays the host\'s IP number… [See Man Page]'
...
complete -c last -s s -l since --description 'Display the state of logins since the specified R time .'
complete -c last -s t -l until --description 'Display the state of logins until the specified R time .'
complete -c last -l time-format --description 'Define the output timestamp  format to be one o… [See Man Page]'
