...
complete -c x509 -o pubkey --description 'outputs the the certificate\'s SubjectPublicKeyI… [See Man Page]'
...
complete -c x509 -o ocspid --description 'outputs the \\s-1OCSP\\s0 hash values for the sub… [See Man Page]'
...
complete -c x509 -o checkend --description 'checks if the certificate expires within the ne… [See Man Page]'
...
complete -c x509 -o force_pubkey --description 'when a certificate is created set its public ke… [See Man Page]'
