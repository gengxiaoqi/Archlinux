...
complete -c dvbv5-zap -s c -l channels --description 'Read channels list from \'file\'.  Defaults to ~/. tzap/channels.'
...
complete -c dvbv5-zap -s C -l cc --description 'Set the default country to be used by the MPEG-… [See Man Page]'
...
complete -c dvbv5-zap -s L -l search --description 'Search/look for a string inside the traffic.'
...
complete -c dvbv5-zap -s t -l timeout --description 'Amount of seconds to keep the tool running for … [See Man Page]'
...
complete -c dvbv5-zap -s w -l lna --description 'Enable, disable or put LNA power in auto mode.'
...
complete -c dvbv5-zap -l version --description 'Prints program version.  EXIT STATUS On success, it returns 0.'
