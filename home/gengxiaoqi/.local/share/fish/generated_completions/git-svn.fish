...
complete -c git-svn -l 'shared[' -l template --description 'Only used with the init command.'
...
complete -c git-svn -o 'A<filename>' -l authors-file --description 'Syntax is compatible with the file used by git cvsimport: .'
complete -c git-svn -l authors-prog --description 'If this option is specified, for each SVN commi… [See Man Page]'
...
complete -c git-svn -s n -l dry-run --description 'This can be used with the dcommit, rebase, bran… [See Man Page]'
complete -c git-svn -l use-log-author --description 'When retrieving svn commits into Git (as part o… [See Man Page]'
complete -c git-svn -l add-author-from --description 'When committing to svn from Git (as part of com… [See Man Page]'
...
complete -c git-svn -l 'parent.' --description 'fetch command will be able to update revisions … [See Man Page]'
