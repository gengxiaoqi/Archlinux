...
complete -c git-diff -l compaction-heuristic -l no-compaction-heuristic --description 'These are to help debugging and tuning an exper… [See Man Page]'
...
complete -c git-diff -l check --description 'Warn if changes introduce conflict markers or w… [See Man Page]'
complete -c git-diff -l ws-error-highlight --description 'Highlight whitespace errors on lines specified … [See Man Page]'
...
complete -c git-diff -o 'S<string>' --description 'Look for differences that change the number of … [See Man Page]'
complete -c git-diff -o 'G<regex>' --description 'Look for differences whose patch text contains … [See Man Page]'
complete -c git-diff -l pickaxe-all --description 'When -S or -G finds a change, show all the chan… [See Man Page]'
complete -c git-diff -l pickaxe-regex --description 'Treat the <string> given to -S as an extended P… [See Man Page]'
...
complete -c git-diff -l color --description '(i. e.  without =<when>) is the same as.'
