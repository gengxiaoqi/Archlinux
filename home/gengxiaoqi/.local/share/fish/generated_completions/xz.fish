...
complete -c xz -s c -l stdout -l to-stdout --description 'Write the compressed or decompressed data to st… [See Man Page]'
...
complete -c xz -s S -l suffix --description 'When compressing, use  .'
complete -c xz -l 'files[' --description 'Read the filenames to process from R file ; if … [See Man Page]'
complete -c xz -l 'files0[' --description 'This is identical to --files[=file] except that… [See Man Page]'
...
complete -c xz -l ignore-check --description 'Don\'t verify the integrity check of the compres… [See Man Page]'
...
complete -c xz -s 4 -s 6 --description 'Good to very good compression while keeping dec… [See Man Page]'
complete -c xz -s 7 --description 'These are like  -6 but with higher compressor a… [See Man Page]'
complete -c xz -s e -l extreme --description 'Use a slower variant of the selected compression preset level .'
complete -c xz -l best --description 'PD These are somewhat misleading aliases for  -… [See Man Page]'
...
complete -c xz -l flush-timeout --description 'When compressing, if more than  timeout millise… [See Man Page]'
...
complete -c xz -s M -l memlimit -l memory --description 'This is equivalent to specifying --memlimit-com… [See Man Page]'
complete -c xz -l no-adjust --description 'Display an error and exit if the compression se… [See Man Page]'
...
complete -c xz -s q -l quiet --description 'Suppress warnings and notices.'
complete -c xz -s v -l verbose --description 'Be verbose.'
complete -c xz -s Q -l no-warn --description 'Don\'t set the exit status to 2 even if a condit… [See Man Page]'
complete -c xz -l robot --description 'Print messages in a machine-parsable format.'
complete -c xz -l info-memory --description 'Display, in human-readable format, how much phy… [See Man Page]'
complete -c xz -s h -l help --description 'Display a help message describing the most comm… [See Man Page]'
complete -c xz -s H -l long-help --description 'Display a help message describing all features … [See Man Page]'
...
complete -c xz -o '9e	64' --description 'For example, there are a total of four presets … [See Man Page]'
...
complete -c xz -s V -l version --description 'Display the version number of xz and liblzma in… [See Man Page]'
...
complete -c xz -l rsyncable --description 'has been implemented, the resulting files won\'t… [See Man Page]'
...
complete -c xz -o T1 --description 'for xz is there to force it to single-threaded … [See Man Page]'
...
complete -c xz -o vv --description '( --verbose --verbose ) like in the above examp… [See Man Page]'
complete -c xz -l x86 --description 'is specified after.'
complete -c xz -l lzma2 --description 'xz will give an error, because there cannot be … [See Man Page]'
