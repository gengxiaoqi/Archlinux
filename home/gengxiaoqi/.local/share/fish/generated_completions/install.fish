...
complete -c install -s C -l compare --description 'compare each pair of source and destination fil… [See Man Page]'
complete -c install -s d -l directory --description 'treat all arguments as directory names; create … [See Man Page]'
complete -c install -s D --description 'create all leading components of DEST except th… [See Man Page]'
...
complete -c install -s p -l preserve-timestamps --description 'apply access/modification times of SOURCE files… [See Man Page]'
...
complete -c install -s Z --description 'set SELinux security context of destination fil… [See Man Page]'
complete -c install -l 'context[' --description 'like -Z, or if CTX is specified then set the SE… [See Man Page]'
