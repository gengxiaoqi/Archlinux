...
complete -c git-rev-parse -l verify --description 'Verify that exactly one parameter is provided, … [See Man Page]'
...
complete -c git-rev-parse -l short -l short --description 'Instead of outputting the full SHA-1 values of … [See Man Page]'
complete -c git-rev-parse -l symbolic --description 'Usually the object names are output in SHA-1 fo… [See Man Page]'
...
complete -c git-rev-parse -l resolve-git-dir --description 'Check if <path> is a valid repository or a gitf… [See Man Page]'
complete -c git-rev-parse -l git-path --description 'Resolve "$GIT_DIR/<path>" and takes other path … [See Man Page]'
