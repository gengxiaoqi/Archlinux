...
complete -c udevadm -l debug --description 'Print debug messages to standard error.'
complete -c udevadm -l version --description 'Print version number.'
complete -c udevadm -s h -l help --description 'Print help text.'
complete -c udevadm -s q -l query --description 'Query the database for the specified type of device data.'
complete -c udevadm -s p -l path --description 'The /sys path of the device to query, e. g.'
complete -c udevadm -s n -l name --description 'The name of the device node or a symlink to query, e. g.'
complete -c udevadm -s r -l root --description 'Print absolute paths in name or symlink query.'
complete -c udevadm -s a -l attribute-walk --description 'Print all sysfs properties of the specified dev… [See Man Page]'
complete -c udevadm -s x -l export --description 'Print output as key/value pairs.'
complete -c udevadm -s P -l export-prefix --description 'Add a prefix to the key name of exported values.'
complete -c udevadm -s d -l device-id-of-file --description 'Print major/minor numbers of the underlying dev… [See Man Page]'
...
complete -c udevadm -s t -l type --description 'Trigger a specific type of devices.'
complete -c udevadm -l action --description 'Type of event to be triggered.  The default value is change.'
complete -c udevadm -s s -l subsystem-match --description 'Trigger events for devices which belong to a ma… [See Man Page]'
complete -c udevadm -s S -l subsystem-nomatch --description 'Do not trigger events for devices which belong … [See Man Page]'
complete -c udevadm -l attr-match --description 'Trigger events for devices with a matching sysfs attribute.'
complete -c udevadm -s A -l attr-nomatch --description 'Do not trigger events for devices with a matchi… [See Man Page]'
...
complete -c udevadm -s y -l sysname-match --description 'Trigger events for devices with a matching sys device path.'
...
complete -c udevadm -s R -l reload --description 'Signal systemd-udevd to reload the rules files … [See Man Page]'
complete -c udevadm -l property --description 'Set a global property for all events.'
complete -c udevadm -s m -l children-max --description 'Set the maximum number of events, systemd-udevd… [See Man Page]'
