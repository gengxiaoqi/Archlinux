...
complete -c git-config -l name-only --description 'Output only the names of config variables for -… [See Man Page]'
...
complete -c git-config -l '[no-]includes' --description 'Respect include.'
complete -c git-config -l 'replace-all.' --description '.'
complete -c git-config -l 'get-regexp.' --description '.'
complete -c git-config -s u --description 'option to git-status(1) when the command takes … [See Man Page]'
...
complete -c git-config -l no-keep-cr --description 'from the command line.  See git-am(1), git-mailsplit(1).  am.'
complete -c git-config -l 3way --description 'option from the command line).  Defaults to false.'
...
complete -c git-config -l preserve-merges --description 'along to git rebase so that locally committed m… [See Man Page]'
...
complete -c git-config -l from --description 'option to format-patch.'
...
complete -c git-config -s n --description 'option by default.  grep. patternType.'
...
complete -c git-config -l perl-regexp --description 'option accordingly, while the value default wil… [See Man Page]'
...
complete -c git-config -l quiet --description 'was specified) while processing the pack, causi… [See Man Page]'
...
complete -c git-config -l annotate --description 'is specified on the command line, it takes prec… [See Man Page]'
