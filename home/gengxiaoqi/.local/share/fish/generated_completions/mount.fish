...
complete -c mount -l source --description 'options to avoid ambivalent interpretation of t… [See Man Page]'
complete -c mount -l fstab --description 'command-line option (see below for more details).'
complete -c mount -s F --description 'option will make mount fork, so that the filesy… [See Man Page]'
complete -c mount -l bind --description 'For example: mount --bind,ro foo foo This featu… [See Man Page]'
complete -c mount -s o --description 'argument, and finally applying a.'
complete -c mount -s r -s w --description 'option, when present.'
complete -c mount -s a -l all --description 'Mount all filesystems (of the given types) ment… [See Man Page]'
complete -c mount -s B --description 'Remount a subtree somewhere else (so that its c… [See Man Page]'
...
complete -c mount -l fake --description 'Causes everything to be done except for the act… [See Man Page]'
complete -c mount -s v --description 'flag to determine what the mount command is trying to do.'
complete -c mount -s i -l internal-only --description 'Don\'t call the /sbin/mount.'
...
complete -c mount -s R -l rbind --description 'Remount a subtree and all possible submounts so… [See Man Page]'
...
complete -c mount -l rw -l read-write --description 'Mount the filesystem read/write.   This is the default.'
