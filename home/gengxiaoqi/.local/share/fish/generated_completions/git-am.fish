...
complete -c git-am -s m -l message-id --description 'Pass the -m flag to git mailinfo (see git-maili… [See Man Page]'
...
complete -c git-am -s 3 -l 3way -l no-3way --description 'When the patch does not apply cleanly, fall bac… [See Man Page]'
complete -c git-am -l ignore-space-change -l ignore-whitespace -l whitespace -o 'C<n>' -o 'p<n>' -l directory -l exclude -l include -l reject --description 'These flags are passed to the git apply (see gi… [See Man Page]'
...
complete -c git-am -l ignore-date --description 'By default the command records the date from th… [See Man Page]'
