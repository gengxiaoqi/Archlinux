...
complete -c git-format-patch -l compaction-heuristic -l no-compaction-heuristic --description 'These are to help debugging and tuning an exper… [See Man Page]'
...
complete -c git-format-patch -l base --description 'Record the base tree information to identify th… [See Man Page]'
...
complete -c git-format-patch -l -P---X---A---M---C --description '    \\         /      Y---Z---B You can also use… [See Man Page]'
