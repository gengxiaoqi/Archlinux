...
complete -c journalctl -l no-hostname --description 'Don\\*(Aqt show the hostname field of log messag… [See Man Page]'
...
complete -c journalctl -s t -l identifier --description 'Show messages for the specified syslog identifi… [See Man Page]'
...
complete -c journalctl -s S -l since -s U -l until --description 'Start showing entries on or newer than the spec… [See Man Page]'
complete -c journalctl -s F -l field --description 'Print all possible data values the specified fi… [See Man Page]'
complete -c journalctl -s N -l fields --description 'Print all field names currently used in all ent… [See Man Page]'
...
complete -c journalctl -l vacuum-size -l vacuum-time -l vacuum-files --description 'Removes archived journal files until the disk s… [See Man Page]'
...
complete -c journalctl -l sync --description 'Asks the journal daemon to write all yet unwrit… [See Man Page]'
complete -c journalctl -l flush --description 'Asks the journal daemon to flush any log data s… [See Man Page]'
