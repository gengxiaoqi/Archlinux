...
complete -c out123 -l test-format --description 'Check if given format is supported by given dri… [See Man Page]'
complete -c out123 -l test-encodings --description 'Print out the short names of encodings supporte… [See Man Page]'
complete -c out123 -l query-format --description 'If the selected driver and device communicate s… [See Man Page]'
