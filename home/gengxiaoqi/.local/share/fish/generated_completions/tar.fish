...
complete -c tar -l check-device --description 'Check device numbers when creating incremental … [See Man Page]'
complete -c tar -s g -l listed-incremental --description 'Handle new GNU-format incremental backups.'
complete -c tar -l hole-detection --description 'Use METHOD to detect holes in sparse files.'
...
complete -c tar -l keep-newer-files --description 'Don\'t replace existing files that are newer tha… [See Man Page]'
complete -c tar -l no-overwrite-dir --description 'Preserve metadata of existing directories.'
complete -c tar -l 'one-top-level[' --description 'Extract all files into DIR, or, if used without… [See Man Page]'
complete -c tar -l overwrite --description 'Overwrite existing files when extracting.'
complete -c tar -l overwrite-dir --description 'Overwrite metadata of existing directories when… [See Man Page]'
complete -c tar -l recursive-unlink --description 'Recursively remove all files in the directory p… [See Man Page]'
complete -c tar -l remove-files --description 'Remove files from disk after adding them to the archive.'
complete -c tar -l skip-old-files --description 'Don\'t replace existing files when extracting, s… [See Man Page]'
complete -c tar -s U -l unlink-first --description 'Remove each file prior to extracting over it.'
complete -c tar -s W -l verify --description 'Verify the archive after writing it.'
...
complete -c tar -l 'atime-preserve[' --description 'Preserve access times on dumped files, either b… [See Man Page]'
complete -c tar -l delay-directory-restore --description 'Delay setting modification times and permission… [See Man Page]'
complete -c tar -l group --description 'Force NAME as group for added files.'
complete -c tar -l group-map --description 'Read group translation map from FILE.'
...
complete -c tar -l no-delay-directory-restore --description 'Cancel the effect of the prior --delay-director… [See Man Page]'
complete -c tar -l no-same-owner --description 'Extract files as yourself (default for ordinary users).'
complete -c tar -l no-same-permissions --description 'Apply the user\'s umask when extracting permissi… [See Man Page]'
...
complete -c tar -l owner-map --description 'Read owner translation map from FILE.'
complete -c tar -s p -l preserve-permissions -l same-permissions --description 'extract information about file permissions (def… [See Man Page]'
complete -c tar -l preserve --description 'Same as both -p and -s.'
complete -c tar -l same-owner --description 'Try extracting files with the same ownership as… [See Man Page]'
complete -c tar -s s -l preserve-order -l same-order --description 'Sort names to extract to match archive.'
complete -c tar -l sort --description 'When creating an archive, sort directory entrie… [See Man Page]'
...
complete -c tar -l volno-file --description 'When this option is used in conjunction with  -… [See Man Page]'
complete -c tar -s b -l blocking-factor --description 'Set record size to BLOCKSx512 bytes.'
complete -c tar -s B -l read-full-records --description 'When listing or extracting, accept incomplete i… [See Man Page]'
...
complete -c tar -s Z -l compress -l uncompress --description 'Filter the archive through  compress (1).'
complete -c tar -l add-file --description 'Add FILE to the archive (useful if its name sta… [See Man Page]'
...
complete -c tar -l exclude --description 'Exclude files matching PATTERN, a  glob (3)-sty… [See Man Page]'
...
complete -c tar -l exclude-caches-all --description 'Exclude directories containing file CACHEDIR.'
...
complete -c tar -l exclude-ignore-recursive --description 'Same as --exclude-ignore, except that patterns … [See Man Page]'
complete -c tar -l exclude-tag --description 'Exclude contents of directories containing FILE… [See Man Page]'
...
complete -c tar -l exclude-vcs-ignores --description 'Exclude files that match patterns read from VCS… [See Man Page]'
...
complete -c tar -l newer-mtime --description 'Work on files whose data changed after the DATE.'
...
complete -c tar -l no-verbatim-files-from --description 'Treat each line read from a file list as if it … [See Man Page]'
complete -c tar -l null --description 'Instruct subsequent -T options to read null-ter… [See Man Page]'
...
complete -c tar -s P -l absolute-names --description 'Don\'t strip leading slashes from file names whe… [See Man Page]'
...
complete -c tar -l verbatim-files-from --description 'Treat each line obtained from a file list as a … [See Man Page]'
complete -c tar -s X -l exclude-from --description 'Exclude files matching patterns listed in FILE.'
...
complete -c tar -l wildcards-match-slash --description 'Wildcards match / (default for exclusion).'
...
complete -c tar -l clamp-mtime --description 'Only set time when the file is more recent than… [See Man Page]'
...
complete -c tar -l show-omitted-dirs --description 'When listing or extracting, list each directory… [See Man Page]'
complete -c tar -l show-transformed-names -l show-stored-names --description 'Show file or archive names after transformation… [See Man Page]'
...
complete -c tar -s w -l interactive -l confirmation --description 'Ask for confirmation for every action.'
...
complete -c tar -s u -l update --description 'Append files which are newer than the correspon… [See Man Page]'
...
complete -c tar -s '?' -l help --description 'Display a short option summary and exit.'
complete -c tar -l usage --description 'Display a list of available options and exit.'
complete -c tar -l version --description 'Print program version and copyright information and exit.'
complete -c tar -l 'sparse.' --description 'raw.'
