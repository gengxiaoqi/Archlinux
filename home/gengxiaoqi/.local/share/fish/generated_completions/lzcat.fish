...
complete -c lzcat -s c -l stdout -l to-stdout --description 'Write the compressed or decompressed data to st… [See Man Page]'
...
complete -c lzcat -l 'files[' --description 'Read the filenames to process from R file ; if … [See Man Page]'
complete -c lzcat -l 'files0[' --description 'This is identical to --files[=file] except that… [See Man Page]'
...
complete -c lzcat -l ignore-check --description 'Don\'t verify the integrity check of the compres… [See Man Page]'
...
complete -c lzcat -s 4 -s 6 --description 'Good to very good compression while keeping dec… [See Man Page]'
complete -c lzcat -s 7 --description 'These are like  -6 but with higher compressor a… [See Man Page]'
complete -c lzcat -s e -l extreme --description 'Use a slower variant of the selected compression preset level .'
complete -c lzcat -l best --description 'PD These are somewhat misleading aliases for  -… [See Man Page]'
...
complete -c lzcat -l flush-timeout --description 'When compressing, if more than  timeout millise… [See Man Page]'
...
complete -c lzcat -s M -l memlimit -l memory --description 'This is equivalent to specifying --memlimit-com… [See Man Page]'
complete -c lzcat -l no-adjust --description 'Display an error and exit if the compression se… [See Man Page]'
...
complete -c lzcat -s Q -l no-warn --description 'Don\'t set the exit status to 2 even if a condit… [See Man Page]'
complete -c lzcat -l robot --description 'Print messages in a machine-parsable format.'
complete -c lzcat -l info-memory --description 'Display, in human-readable format, how much phy… [See Man Page]'
complete -c lzcat -s h -l help --description 'Display a help message describing the most comm… [See Man Page]'
complete -c lzcat -s H -l long-help --description 'Display a help message describing all features … [See Man Page]'
...
complete -c lzcat -o '9e	64' --description 'For example, there are a total of four presets … [See Man Page]'
...
complete -c lzcat -s V -l version --description 'Display the version number of xz and liblzma in… [See Man Page]'
...
complete -c lzcat -l rsyncable --description 'has been implemented, the resulting files won\'t… [See Man Page]'
...
complete -c lzcat -o T1 --description 'for xz is there to force it to single-threaded … [See Man Page]'
...
complete -c lzcat -o vv --description '( --verbose --verbose ) like in the above examp… [See Man Page]'
complete -c lzcat -l x86 --description 'is specified after.'
complete -c lzcat -l lzma2 --description 'xz will give an error, because there cannot be … [See Man Page]'
