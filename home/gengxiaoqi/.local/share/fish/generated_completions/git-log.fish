...
complete -c git-log -l expand-tabs -l expand-tabs -l no-expand-tabs --description 'Perform a tab expansion (replace each tab with … [See Man Page]'
...
complete -c git-log -l 'date.' --description ' 4. c   4.  4. 2.'
...
complete -c git-log -l 'raw.' --description '.'
complete -c git-log -l compaction-heuristic -l no-compaction-heuristic --description '.'
