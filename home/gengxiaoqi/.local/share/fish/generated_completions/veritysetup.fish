...
complete -c veritysetup -l ignore-corruption -l restart-on-corruption --description 'Defines what to do if data integrity problem is… [See Man Page]'
complete -c veritysetup -l ignore-zero-blocks --description 'Instruct kernel to not verify blocks that are e… [See Man Page]'
complete -c veritysetup -l 'uuid]' --description '.'
complete -c veritysetup -l 'ignore-zero-blocks]' --description '.'
