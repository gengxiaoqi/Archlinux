...
complete -c realpath -l relative-to --description 'print the resolved path relative to FILE.'
complete -c realpath -l relative-base --description 'print absolute paths unless paths below FILE.'
...
complete -c realpath -l version --description 'output version information and exit AUTHOR Writ… [See Man Page]'
