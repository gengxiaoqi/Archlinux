...
complete -c msgattrib -l previous --description 'when setting \'fuzzy\', keep previous msgids of t… [See Man Page]'
...
complete -c msgattrib -l obsolete --description 'synonym for --only-obsolete --clear-obsolete .'
complete -c msgattrib -s P -l properties-input --description 'input file is in Java . properties syntax.'
complete -c msgattrib -l stringtable-input --description 'input file is in NeXTstep/GNUstep . strings syntax .'
...
complete -c msgattrib -l no-wrap --description 'do not break long message lines, longer than th… [See Man Page]'
...
complete -c msgattrib -s V -l version --description 'output version information and exit AUTHOR Writ… [See Man Page]'
