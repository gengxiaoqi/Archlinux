...
complete -c git-diff-index -l compaction-heuristic -l no-compaction-heuristic --description 'These are to help debugging and tuning an exper… [See Man Page]'
...
complete -c git-diff-index -l check --description 'Warn if changes introduce conflict markers or w… [See Man Page]'
complete -c git-diff-index -l ws-error-highlight --description 'Highlight whitespace errors on lines specified … [See Man Page]'
