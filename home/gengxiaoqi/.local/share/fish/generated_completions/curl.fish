...
complete -c curl -s : -l next --description 'Tells curl to use a separate operation for the … [See Man Page]'
...
complete -c curl -l http2 --description '(HTTP) Tells curl to issue its requests using HTTP 2.'
complete -c curl -l http2-prior-knowledge --description '(HTTP) Tells curl to issue its non-TLS HTTP req… [See Man Page]'
complete -c curl -l no-npn --description 'Disable the NPN TLS extension.'
complete -c curl -l no-alpn --description 'Disable the ALPN TLS extension.'
complete -c curl -s 1 -l tlsv1 --description '(SSL) Forces curl to use TLS version 1.'
...
complete -c curl -s 4 -l ipv4 --description 'This option tells curl to resolve names to IPv4… [See Man Page]'
complete -c curl -s 6 -l ipv6 --description 'This option tells curl to resolve names to IPv6… [See Man Page]'
complete -c curl -s a -l append --description '(FTP/SFTP) When used in an upload, this makes c… [See Man Page]'
...
complete -c curl -l basic --description '(HTTP) Tells curl to use HTTP Basic authenticat… [See Man Page]'
complete -c curl -s c -l cookie-jar --description '(HTTP) Specify to which file you want curl to w… [See Man Page]'
...
complete -c curl -l connect-timeout --description 'Maximum time in seconds that you allow curl\'s c… [See Man Page]'
complete -c curl -l create-dirs --description 'When used in conjunction with the -o option, cu… [See Man Page]'
complete -c curl -l crlf --description 'Convert LF to CRLF in upload.  Useful for MVS (OS/390).'
...
complete -c curl -l data-ascii --description 'See -d, --data.'
complete -c curl -l data-binary --description '(HTTP) This posts data exactly as specified wit… [See Man Page]'
complete -c curl -l data-raw --description '(HTTP) This posts data similarly to --data but … [See Man Page]'
...
complete -c curl -l dns-interface --description 'Tell curl to send outgoing DNS requests through <interface>.'
complete -c curl -l dns-ipv4-addr --description 'Tell curl to bind to <ip-address> when making I… [See Man Page]'
complete -c curl -l dns-ipv6-addr --description 'Tell curl to bind to <ip-address> when making I… [See Man Page]'
complete -c curl -l dns-servers --description 'Set the list of DNS servers to be used instead … [See Man Page]'
complete -c curl -s e -l referer --description '(HTTP) Sends the "Referrer Page" information to… [See Man Page]'
...
complete -c curl -l expect100-timeout --description '(HTTP) Maximum time in seconds that you allow c… [See Man Page]'
...
complete -c curl -l pinnedpubkey --description '(SSL) Tells curl to use the specified public ke… [See Man Page]'
complete -c curl -l cert-status --description '(SSL) Tells curl to verify the status of the se… [See Man Page]'
complete -c curl -l false-start --description '(SSL) Tells curl to use false start during the TLS handshake.'
...
complete -c curl -l ftp-ssl --description '(FTP) This deprecated option is now known as --ssl.'
complete -c curl -l ftp-ssl-reqd --description '(FTP) This deprecated option is now known as --ssl-reqd.'
...
complete -c curl -s H -l header --description '(HTTP) Extra header to include in the request w… [See Man Page]'
complete -c curl -l hostpubmd5 --description '(SCP/SFTP) Pass a string containing 32 hexadecimal digits.'
complete -c curl -l ignore-content-length --description 'For HTTP, Ignore the Content-Length header.'
...
complete -c curl -l krb4 --description '(FTP) This is the former name for --krb.  Do not use.'
...
complete -c curl -l limit-rate --description 'Specify the maximum transfer rate you want curl… [See Man Page]'
...
complete -c curl -l login-options --description 'Specify the login options to use during server authentication.'
...
complete -c curl -l mail-rcpt --description '(SMTP) Specify a single address, user name or m… [See Man Page]'
complete -c curl -l max-redirs --description 'Set maximum number of redirection-followings allowed.'
complete -c curl -l metalink --description 'This option can tell curl to parse and process … [See Man Page]'
...
complete -c curl -l connect-to --description 'For a request to the given "host:port" pair, co… [See Man Page]'
complete -c curl -l ntlm --description '(HTTP) Enables NTLM authentication.'
complete -c curl -l ntlm-wb --description '(HTTP) Enables NTLM much in the style --ntlm do… [See Man Page]'
...
complete -c curl -l proxy-header --description '(HTTP) Extra header to include in the request w… [See Man Page]'
...
complete -c curl -l path-as-is --description 'Tell curl to not handle sequences of /. / or /.'
complete -c curl -l post301 --description '(HTTP) Tells curl to respect RFC 7230/6. 4.'
complete -c curl -l post302 --description '(HTTP) Tells curl to respect RFC 7230/6. 4.'
complete -c curl -l post303 --description '(HTTP) Tells curl to respect RFC 7230/6. 4.'
...
complete -c curl -l proto-redir --description 'Tells curl to use the listed protocols on redirect.'
...
complete -c curl -l proxy-negotiate --description 'Tells curl to use HTTP Negotiate (SPNEGO) authe… [See Man Page]'
complete -c curl -l proxy-ntlm --description 'Tells curl to use HTTP NTLM authentication when… [See Man Page]'
complete -c curl -l proxy-service-name --description 'This option allows you to change the service na… [See Man Page]'
...
complete -c curl -s q -l disable --description 'If used as the first parameter on the command l… [See Man Page]'
...
complete -c curl -s R -l remote-time --description 'When used, this will make curl attempt to figur… [See Man Page]'
complete -c curl -l random-file --description '(SSL) Specify the path name to file containing … [See Man Page]'
complete -c curl -l raw --description '(HTTP) When used, it disables all internal HTTP… [See Man Page]'
...
complete -c curl -l sasl-ir --description 'Enable initial response in SASL authentication.  (Added in 7.'
...
complete -c curl -l ssl-allow-beast --description '(SSL) This option tells curl to not work around… [See Man Page]'
complete -c curl -l ssl-no-revoke --description '(WinSSL) This option tells curl to disable cert… [See Man Page]'
...
complete -c curl -l socks5-gssapi-nec --description 'As part of the GSS-API negotiation a protection… [See Man Page]'
...
complete -c curl -l 'tlsv1.0' --description '(SSL) Forces curl to use TLS version 1.'
complete -c curl -l 'tlsv1.1' --description '(SSL) Forces curl to use TLS version 1.'
complete -c curl -l 'tlsv1.2' --description '(SSL) Forces curl to use TLS version 1.'
...
complete -c curl -l unix-socket --description '(HTTP) Connect through this Unix domain socket,… [See Man Page]'
...
complete -c curl -s v -l verbose --description 'Be more verbose/talkative during the operation.'
complete -c curl -s w -l write-out --description 'Make curl display information on stdout after a… [See Man Page]'
...
complete -c curl -s z -l time-cond --description '(HTTP/FTP) Request a file that has been modifie… [See Man Page]'
...
complete -c curl -l 'data-ascii.' --description 'the same but does not have a special interpreta… [See Man Page]'
...
complete -c curl -l 'post303.' --description '.'
