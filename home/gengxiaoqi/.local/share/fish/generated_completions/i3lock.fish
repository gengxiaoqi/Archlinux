...
complete -c i3lock -s I -l inactivity-timeout --description 'Specifies the number of seconds i3lock will wai… [See Man Page]'
...
complete -c i3lock -s e -l ignore-empty-password --description 'When an empty password is provided by the user,… [See Man Page]'
