...
complete -c git-push -l follow-tags --description 'Push all the refs that would be pushed without … [See Man Page]'
complete -c git-push -l '[no-]signed' -l sign --description 'GPG-sign the push request to update refs on the… [See Man Page]'
complete -c git-push -l '[no-]atomic' --description 'Use an atomic transaction on the remote side if available.'
complete -c git-push -s o -l push-option --description 'Transmit the given string to the server, which … [See Man Page]'
...
complete -c git-push -l '[no-]thin' --description 'These options are passed to git-send-pack(1).'
...
complete -c git-push -l no-recurse-submodules -l recurse-submodules --description 'May be used to make sure all submodule commits … [See Man Page]'
...
complete -c git-push -l signed --description 'if-asked, sign if and only if the server suppor… [See Man Page]'
