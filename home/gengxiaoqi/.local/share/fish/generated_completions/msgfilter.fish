...
complete -c msgfilter -l newline --description 'add a newline at the end of input and remove a … [See Man Page]'
...
complete -c msgfilter -s n -l quiet -l silent --description 'suppress automatic printing of pattern space .'
complete -c msgfilter -s P -l properties-input --description 'input file is in Java . properties syntax.'
complete -c msgfilter -l stringtable-input --description 'input file is in NeXTstep/GNUstep . strings syntax .'
...
complete -c msgfilter -l no-wrap --description 'do not break long message lines, longer than th… [See Man Page]'
...
complete -c msgfilter -s V -l version --description 'output version information and exit AUTHOR Writ… [See Man Page]'
