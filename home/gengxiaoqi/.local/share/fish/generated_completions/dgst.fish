...
complete -c dgst -s r --description 'output the digest in the \\*(L"coreutils\\*(R" fo… [See Man Page]'
...
complete -c dgst -o fips-fingerprint --description 'compute \\s-1HMAC\\s0 using a specific key for ce… [See Man Page]'
