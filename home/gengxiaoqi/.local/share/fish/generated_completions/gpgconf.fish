...
complete -c gpgconf -s o --description 'TQ   --output file Write output to file.'
...
complete -c gpgconf -l create-socketdir --description 'Create a directory for sockets below /run/user … [See Man Page]'
complete -c gpgconf -l remove-socketdir --description 'Remove a directory created with command --create-socketdir.'
