...
complete -c sfdisk -s a -l append --description 'Don\'t create a new partition table, but only ap… [See Man Page]'
complete -c sfdisk -s b -l backup --description 'Back up the current partition table sectors bef… [See Man Page]'
...
complete -c sfdisk -l no-reread --description 'Do not check through the re-read-partition-tabl… [See Man Page]'
complete -c sfdisk -s O -l backup-file --description 'Override the default backup file name.'
complete -c sfdisk -l move-data --description 'Move data after partition relocation, for examp… [See Man Page]'
...
complete -c sfdisk -s w -l wipe --description 'Wipe filesystem, RAID and partition-table signa… [See Man Page]'
complete -c sfdisk -s v -l version --description 'Display version information and exit.'
complete -c sfdisk -s A -l activate --description 'Switch on the bootable flag for the specified partitions.'
...
complete -c sfdisk -s F -l list-free --description 'List the free unpartitioned areas on all or the… [See Man Page]'
...
complete -c sfdisk -s s -l show-size --description 'List the sizes of all or the specified devices.'
complete -c sfdisk -s T -l list-types --description 'Print all supported types for the current disk … [See Man Page]'
complete -c sfdisk -l 'label.' --description '.'
