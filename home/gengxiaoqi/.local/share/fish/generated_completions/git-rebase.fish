...
complete -c git-rebase -l keep-empty --description 'Keep the commits that do not change anything fr… [See Man Page]'
...
complete -c git-rebase -s f -l force-rebase --description 'Force a rebase even if the current branch is up… [See Man Page]'
complete -c git-rebase -l fork-point -l no-fork-point --description 'Use reflog to find a better common ancestor bet… [See Man Page]'
...
complete -c git-rebase -s p -l preserve-merges --description 'Recreate merge commits instead of flattening th… [See Man Page]'
complete -c git-rebase -s x -l exec --description 'Append "exec <cmd>" after each line creating a … [See Man Page]'
...
complete -c git-rebase -l autostash -l no-autostash --description 'Automatically create a temporary stash before t… [See Man Page]'
