...
complete -c systemctl -s a -l all --description 'When listing units with list-units, also show i… [See Man Page]'
...
complete -c systemctl -l value --description 'When printing properties with show, only print … [See Man Page]'
...
complete -c systemctl -l 'all.' --description 'PATTERNs are specified, only units matching one… [See Man Page]'
