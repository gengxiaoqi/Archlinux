...
complete -c pulseaudio -l cleanup-shm --description 'Identify stale PulseAudio POSIX shared memory s… [See Man Page]'
complete -c pulseaudio -l start --description 'Start PulseAudio if it is not running yet.'
complete -c pulseaudio -s k -l kill --description 'Kill an already running PulseAudio daemon of th… [See Man Page]'
complete -c pulseaudio -l check --description 'Return 0 as return code when the PulseAudio dae… [See Man Page]'
...
complete -c pulseaudio -l 'fail[' --description 'Fail startup when any of the commands specified… [See Man Page]'
complete -c pulseaudio -l 'high-priority[' --description 'Try to acquire a high Unix nice level.'
complete -c pulseaudio -l 'realtime[' --description 'Try to acquire a real-time scheduling for Pulse… [See Man Page]'
...
complete -c pulseaudio -l exit-idle-time --description 'Terminate the daemon when idle and the specifie… [See Man Page]'
complete -c pulseaudio -l scache-idle-time --description 'Unload autoloaded samples from the cache when t… [See Man Page]'
complete -c pulseaudio -l 'log-level[' --description 'If an argument is passed, set the log level to … [See Man Page]'
complete -c pulseaudio -s v -l verbose --description 'Increase the configured verbosity level by one … [See Man Page]'
...
complete -c pulseaudio -l log-backtrace --description 'When FRAMES is greater than 0, log for each mes… [See Man Page]'
complete -c pulseaudio -s p -l dl-search-path --description 'Set the search path for dynamic shared objects (plugins).'
complete -c pulseaudio -l resample-method --description 'Use the specified resampler by default (See --d… [See Man Page]'
...
complete -c pulseaudio -l 'disable-shm[' --description 'PulseAudio clients and the server can exchange … [See Man Page]'
complete -c pulseaudio -l 'enable-memfd[' --description 'PulseAudio clients and the server can exchange … [See Man Page]'
...
complete -c pulseaudio -s n --description 'Don\'t load default script file default.'
