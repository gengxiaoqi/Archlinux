...
complete -c cryptsetup -l perf-submit_from_crypt_cpus --description 'Disable offloading writes to a separate thread … [See Man Page]'
...
complete -c cryptsetup -l 'header].' --description '.'
complete -c cryptsetup -l 'header]' --description '.'
complete -c cryptsetup -l 'allow-discards].' --description '.'
