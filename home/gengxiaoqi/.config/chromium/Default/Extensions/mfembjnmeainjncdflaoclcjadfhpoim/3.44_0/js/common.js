...
(function(k) {
  ...
  f.flash = l.all && !m.opera ? function(a) {
    ...
    b.setAttribute("pluginspage", "http://get.adobe.com/flashplayer/");
    for(var c in a) {
    ...
    b.setAttribute("type", "application/x-shockwave-flash");
    b.setAttribute("codebase", "http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9.0.115");
