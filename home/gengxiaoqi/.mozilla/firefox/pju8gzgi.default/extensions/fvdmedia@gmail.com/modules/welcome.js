...
var WELCOME_URL = "https://nimbus.everhelper.me/app-update/misc.php?v={VERSION}",
    WELCOME_IMAGE_SRC = "chrome://fvd.sync/skin/icon_new.png",
    EXTENSION_ID = "fvdmedia@gmail.com",
    BUTTON_ID = "fvd_sync_MainButton";
// end settings
  ...
  function restore(){
    ...
    while (windows.hasMoreElements()) {
      ...
      if(btn && btn.hasAttribute("fvd-welcome-active")){
        ...
        btn.removeEventListener("mousedown", clickListener, true);
      }
    }     
  }
  ...
  function setupButton(){
    ...
    while (windows.hasMoreElements()) {
      ...
      if(btn && !btn.hasAttribute("fvd-welcome-active")){
        ...
        btn.addEventListener("mousedown", clickListener, true);
      }
    }     
  }
